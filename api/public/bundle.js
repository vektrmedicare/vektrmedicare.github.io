				...
				(0, _createClass3.default)(View, [
					{
						...
						value: function render() {
							...
							this.el.innerHTML =
								'<p><i class="fa fa-circle-o-notch fa-spin fa-fw"></i> Loading...</p>';
							return this.template(this.context).then(function(
								html
							) {
...
*/
		...
		/***/ function(module, exports, __webpack_require__) {
			/* WEBPACK VAR INJECTION */ (function(global, module) {
				...
				(function() {
					...
					var runInContext = function runInContext(context) {
						...
						function createWrap(
							...
							arity =
								arity === undefined ? arity : toInteger(arity);
						...
						function slice(array, start, end) {
							...
							if (
								...
								start = start == null ? 0 : toInteger(start);
									...
									end === undefined ? length : toInteger(end);
							}
						...
						function rest(func, start) {
							...
							start =
								start === undefined ? start : toInteger(start);
						...
						function pickBy(object, predicate) {
							...
							var props = arrayMap(getAllKeysIn(object), function(
								prop
							) {
								return [prop];
							});
				...
				__webpack_require__(170)(module)
			));
...
*/
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var $keys = __webpack_require__(65);
			var hiddenKeys = __webpack_require__(34).concat(
				'length',
				'prototype'
			);
			...
			var DemoApp = (function(_App) {
				...
				function DemoApp(el) {
					...
					var _this = (0, _possibleConstructorReturn3.default)(
						...
						(
							DemoApp.__proto__ ||
							(0, _getPrototypeOf2.default)(DemoApp)
						).call(this, el, _base2.default)
					);

					_this.api = new _infermedicaApi2.default(
						_settings2.default['app-id'],
						_settings2.default['app-key']
					);
			...
			var BasicView = (function(_View) {
				...
				function BasicView(el, context) {
					...
					var _this = (0, _possibleConstructorReturn3.default)(
						...
						(
							BasicView.__proto__ ||
							(0, _getPrototypeOf2.default)(BasicView)
						).call(this, el, _template2.default, context, binds)
					);
			...
			var _templateObject = (0, _taggedTemplateLiteral3.default)(
				...
				_templateObject2 = (0, _taggedTemplateLiteral3.default)(
					[
						...
						'" type="checkbox" class="input-risk custom-control-input">\n                        <span class="custom-control-indicator"></span>\n                        <span class="custom-control-description">',
						'</span>\n                      </label>\n                    </div>\n                  '
					],
					[
						'\n                    <div class="form-group">\n                      <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">\n                        <input id="',
						...
						resolve(
							(0, _helpers2.default)(
								...
								risks.map(function(risk) {
									if (
										context.commonRiskFactors.indexOf(
											risk.id
										) >= 0
									) {
										return (0, _helpers2.default)(
											_templateObject2,
											risk.id,
											risk.name
										);
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var CommonRisksView = (function(_View) {
				...
				function CommonRisksView(el, context) {
					...
					if (
						context.patient.sex === 'female' &&
						context.patient.age > 39
					) {
					...
					return (_this = (0, _possibleConstructorReturn3.default)(
						this,
						(
							CommonRisksView.__proto__ ||
							(0, _getPrototypeOf2.default)(CommonRisksView)
						).call(this, el, _template2.default, context, binds)
					));
				}
					...
					context.api.getRiskFactors().then(function(risks) {
						resolve(
							(0, _helpers2.default)(
								...
								risks.map(function(risk) {
									if (
										context.locationRiskFactors.indexOf(
											risk.id
										) >= 0
									) {
										return (0, _helpers2.default)(
			...
			var GeoRisksView = (function(_View) {
				...
				function GeoRisksView(el, context) {
					...
					return (_this = (0, _possibleConstructorReturn3.default)(
						this,
						(
							GeoRisksView.__proto__ ||
							(0, _getPrototypeOf2.default)(GeoRisksView)
						).call(this, el, _template2.default, context, binds)
					));
				}
			...
			var NLPView = (function(_View) {
				...
				function NLPView(el, context) {
					...
					var binds = {
						'#input-feel': {
							type: 'input',
							listener: _lodash2.default.debounce(
								handleFeelChange,
								400
							)
						}
					...
					var _this = (0, _possibleConstructorReturn3.default)(
						...
						(
							NLPView.__proto__ ||
							(0, _getPrototypeOf2.default)(NLPView)
						).call(this, el, _template2.default, context, binds)
					);
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var _templateObject = (0, _taggedTemplateLiteral3.default)(
				...
				_templateObject2 = (0, _taggedTemplateLiteral3.default)(
					[
						...
						'" type="radio" class="custom-control-input" name="radio">\n                <span class="custom-control-indicator"></span>\n                <span class="custom-control-description">\n                ',
						'\n              </label>\n            </div>         \n          '
					],
					[
						'\n            <div class="form-check">\n              <label class="custom-control custom-radio form-check-label">\n                <input id="',
			...
			var answersGroupSingle = function answersGroupSingle(items) {
				return (0, _helpers2.default)(
					...
					items.map(function(i) {
						return (0,
						_helpers2.default)(_templateObject2, i.id, i.name);
					})
				);
			};
			...
			var answersGroupMultiple = function answersGroupMultiple(items) {
				return (0, _helpers2.default)(
					...
					items.map(function(i) {
						return (0,
						_helpers2.default)(_templateObject3, i.id, i.name);
					})
				);
			};
				...
				function QuestionView(el, context) {
					...
					var handleNextQuestion = function handleNextQuestion(e) {
						...
						if (_this.context.question.type !== 'single') {
							...
							_this.context.patient.addSymptomsGroup(
								(0, _defineProperty3.default)(
									{},
									_this.context.question.items[0].id,
					...
					return (_this = (0, _possibleConstructorReturn3.default)(
						this,
						(
							QuestionView.__proto__ ||
							(0, _getPrototypeOf2.default)(QuestionView)
						).call(this, el, _template2.default, context, binds)
					));
				}
							...
							this.context.api
								...
								.then(function(data) {
									...
									if (data['should_stop'] === true) {
										...
										(0, _get3.default)(
											QuestionView.prototype.__proto__ ||
												(0, _getPrototypeOf2.default)(
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var _templateObject = (0, _taggedTemplateLiteral3.default)(
				...
				_templateObject2 = (0, _taggedTemplateLiteral3.default)(
					[
						'\n                  <div class="form-group">\n                    <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">\n                      <input id="',
						'" type="checkbox" class="input-symptom custom-control-input">\n                      <span class="custom-control-indicator"></span>\n                      <span class="custom-control-description">',
						'</span>\n                    </label>\n                  </div>\n                '
					],
					[
						'\n                  <div class="form-group">\n                    <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">\n                      <input id="',
			...
			var template = function template(context) {
				return new _promise2.default(function(resolve) {
					context.api
						...
						.then(function(suggestedSymptoms) {
							...
							resolve(
								(0, _helpers2.default)(
									_templateObject,
									_lodash2.default
										.take(suggestedSymptoms, 5)
										.map(function(symptom) {
											return (0,
											_helpers2.default)(_templateObject2, symptom.id, symptom.name);
										})
								)
							);
						});
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var SuggestView = (function(_View) {
				...
				function SuggestView(el, context) {
					...
					var handleSymptomsChange = function handleSymptomsChange(
						e
					) {
						var group = {};
						_this.el
							.querySelectorAll('.input-symptom')
							.forEach(function(item) {
								...
								if (item.checked) {
									...
									_this.context.patient.removeSymptom(
										item.id
									);
								}
							});
					...
					return (_this = (0, _possibleConstructorReturn3.default)(
						this,
						(
							SuggestView.__proto__ ||
							(0, _getPrototypeOf2.default)(SuggestView)
						).call(this, el, _template2.default, context, binds)
					));
				}
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var template = function template(context) {
				return new _promise2.default(function(resolve) {
					context.api
						.diagnosis(context.patient.toDiagnosis())
						.then(function(data) {
							resolve(
								(0, _helpers2.default)(
									_templateObject,
									data.conditions.map(function(condition) {
										return (
											...
											(condition.probability >= 0.2
												? '<i class="fa fa-fw fa-eye"></i><a href data-id="' +
												  condition.id +
												  '" class="explain">explain</a>'
												: '') +
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var SummaryView = (function(_View) {
				...
				function SummaryView(el, context) {
					...
					var getExplanationMarkup = function getExplanationMarkup(
						data
					) {
						var supporting = '';
						var conflicting = '';
						...
						try {
							for (
								...
								supporting +=
									'<li><i class="text-success fa fa-fw fa-plus-circle"></i> ' +
									e.common_name +
									'</li>';
							}
						} catch (err) {
						...
						try {
							for (
								...
								conflicting +=
									'<li><i class="text-danger fa fa-fw fa-minus-circle"></i> ' +
									_e.common_name +
									'</li>';
							}
						} catch (err) {
					...
					var handleExplainRequested = function handleExplainRequested(
						e
					) {
						e.preventDefault();
						var id = e.target.dataset.id;
						var el = e.target.parentNode.parentNode.querySelector(
							'.explanation'
						);
					...
					return (0, _possibleConstructorReturn3.default)(
						this,
						(
							SummaryView.__proto__ ||
							(0, _getPrototypeOf2.default)(SummaryView)
						).call(this, el, _template2.default, context, binds)
					);
				}
			...
			var WelcomeView = (function(_View) {
				...
				function WelcomeView(el, context) {
					...
					var _this = (0, _possibleConstructorReturn3.default)(
						this,
						(
							WelcomeView.__proto__ ||
							(0, _getPrototypeOf2.default)(WelcomeView)
						).call(this, el, _template2.default, context, null)
					);
			...
			var DemoController = (function(_Controller) {
				...
				function DemoController(el) {
					...
					var _this = (0, _possibleConstructorReturn3.default)(
						this,
						(
							DemoController.__proto__ ||
							(0, _getPrototypeOf2.default)(DemoController)
						).call(this, el)
					);
				...
				(0, _createClass3.default)(InfermedicaApi, [
					...
					},
					{
						...
						value: function parse(text) {
							return this._post(
								'parse',
								(0, _stringify2.default)({ text: text })
							);
						}
					},
					{
				...
				(0, _createClass3.default)(Patient, [
					...
					},
					{
						...
						value: function toDiagnosis() {
							...
							res.evidence = _lodash2.default.map(
								this.symptoms,
								function(symptom, symptomId) {
									var getChoiceId = function getChoiceId(
										choice
									) {
										if (choice === true) {
											return 'present';
										...
										if (
											_lodash2.default.isUndefined(choice)
										) {
											return 'unknown';
										}
										if (choice === false) {
					...
					},
					{
						...
						value: function toSuggest() {
							...
							return {
								sex: this.sex,
								age: this.age,
								selected: _lodash2.default.filter(
									_lodash2.default.keys(this.symptoms),
									function(key) {
										return (
											_this.symptoms[key].reported ===
											true
										);
									}
								)
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			$export(
				...
				'Object',
				{ defineProperties: __webpack_require__(62) }
			);
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			if (!USE_NATIVE) {
				...
				Internal.prototype = __webpack_require__(136)(
					$Promise.prototype,
					{
			...
			$export(
				$export.S +
					$export.F *
						!(
							USE_NATIVE &&
							__webpack_require__(131)(function(iter) {
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			if (false) {
				...
				if (!content.locals) {
					module.hot.accept(
						'!!../../../css-loader/index.js!./bootstrap.min.css',
						function() {
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			if (false) {
				...
				if (!content.locals) {
					module.hot.accept(
						'!!../../css-loader/index.js!./font-awesome.min.css',
						function() {
